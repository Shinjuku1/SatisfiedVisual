/**
 * This file Sets up all event listeners for the application and defines their handlers.
 */
import dom from '../../dom.js';
import state from '../../state.js';
import { recipeData } from '../js/data/recipes.js';
import { screenToWorld, getNodeWorldPosition } from '../../utils.js';
import { renderViewport, renderConnections, renderCardSelections, renderSelectionSummary } from '../js/ui/render.js';
import { calculateAndRenderNetworkStatus } from '../js/core/calculations.js';
...
import { showSummaryModal } from '../js/ui/modals.js';
...
export function initializeEventListeners() {
    ...
    dom.importInput.addEventListener('change', (e) => {
        ...
        dom.importInput.value = ''; // Reset for next import
    });

    // Prevent native browser dragging on non-library items
...
function handleKeyDown(e) {
    if (document.activeElement.tagName === 'INPUT' || document.activeElement.tagName === 'SELECT' || state.pastePreview) return;
    ...
    if (e.ctrlKey || e.metaKey) {
        switch(e.key.toLowerCase()) {
            ...
            case 'v': pasteSelection(e, false); break;
        }
    }
    if (e.key === 'Escape' && state.pastePreview) {
