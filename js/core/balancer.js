...
import { showAutoBalanceOptionsModal } from '/SatisfiedVisual/js/ui/modals.js';
...
export function autoBalanceChain(startCard) {
    showAutoBalanceOptionsModal((options) => {
        ...
        for (const cardId of reversedSortedIds) {
            ...
            if (maxRequiredTheoreticalClock > 0) {
                ...
                } else { // 'buildings' strategy (default)
