...
        return;
    }
    // If the click is on a card (and not a connector), let the card's own handler deal with it.
    if (e.target.closest('.placed-card') && !e.target.classList.contains('connector-node')) return;
